...
def open_main_window() -> None:
    """
    Initialise the primary dashboard for the Travel Record Management System.

    Builds and runs the root tkinter window, providing navigation to the
    Client, Airline, and Flight record management modules.
    """
    ...
    help_btn = tk.Button(
        ...
        bg="#5d6d7e", fg="white",  # WCAG AA: 5.31:1
        font=("Arial", 10, "bold"),
        command=show_help
    )
    ...
    exit_btn = tk.Button(
        ...
        bg="#a93226", fg="white",   # WCAG AA: 6.62:1
        font=("Arial", 10, "bold"),
